...
class Rent59ESpider():
    def __init__(self):
        ...
        self.mul_filter_params: Dict[str, str] = {
            ...
            'station': '4231,4184,4200,4232,4183,4201,4188,4181,4233,4234,4189,4245,4242,4201,4246,4247,4221,4180,66264,66266',  
        }
    ...
    def init_google_sheet(self):
        ...
        sheet_name = f"rent_list_{time_name}-kind3".replace("'", "")
